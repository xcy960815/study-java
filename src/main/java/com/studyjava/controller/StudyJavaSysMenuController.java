...
public class StudyJavaSysMenuController extends BaseController {
  /** 服务对象 */
  @Resource private StudyJavaSysMenuService studyJavaSysMenuService;
  ...
  public PageResult<StudyJavaSysMenuVo> getMenuList(
    ...
    IPage<StudyJavaSysMenuVo> menuPage =
        studyJavaSysMenuService.getMenuList(startPage(pageNum, pageSize), studyJavaSysMenuDto);
  ...
  public PageResult<StudyJavaSysMenuVo> getMenuTree(
      ...
      @ModelAttribute StudyJavaSysMenuDto studyJavaSysMenuDto) {
    // 获取所有菜单
    IPage<StudyJavaSysMenuVo> allMenus =
        studyJavaSysMenuService.getMenuList(startPage(pageNum, pageSize), studyJavaSysMenuDto);
