...
public class StudyJavaSysRoleController {
  ...
  @Autowired private StudyJavaSysRoleService studyJavaSysRoleService;
  ...
  public PageResult<StudyJavaSysRoleVo> getRoleList(
    ...
    Page<StudyJavaSysRoleVo> page =
        studyJavaSysRoleService.getRoleList(pageNum, pageSize, queryDto);
