...
import com.studyjava.domain.enums.BusinessStatus;
...
public class StudyJavaLogAspectComponent
{
     ...
     * @throws Exception
     */
    public void getControllerMethodDescription(JoinPoint joinPoint, Log log, StudyJavaSysOperLogDao operLog, Object jsonResult) throws Exception
    {
        // 设置action动作
