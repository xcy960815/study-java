 ...
 * @createDate 2025-05-07 17:46:58 @Entity com.example.domain.dao.StudyJavaSysMenuDao
 */
public interface StudyJavaSysMenuMapper extends BaseMapper<StudyJavaSysMenuDao> {
   ...
   */
  IPage<StudyJavaSysMenuDao> getMenuList(
      @Param("page") IPage<StudyJavaSysMenuDao> page,
      @Param("studyJavaSysMenuDao") StudyJavaSysMenuDao studyJavaSysMenuDao);
   ...
   * @return 单条数据
   */
  StudyJavaSysMenuDao getMenuInfo(
      @Param("studyJavaSysMenuDao") StudyJavaSysMenuDao studyJavaSysMenuDao);
