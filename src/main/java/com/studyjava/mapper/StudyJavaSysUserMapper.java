...
/**
* @author opera
* 针对表【study_java_sys_user】的数据库操作Mapper
* 2024-10-16 11:26:58
...
public interface StudyJavaSysUserMapper extends BaseMapper<StudyJavaSysUserDao> {
    // 获取用户列表
    IPage<StudyJavaSysUserDao> getUserList(@Param("page") IPage<StudyJavaSysUserDao> page, @Param("studyJavaSysUserDao") StudyJavaSysUserDao studyJavaSysUserDao);
    // 更新用户
