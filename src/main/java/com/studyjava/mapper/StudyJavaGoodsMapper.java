 ...
 * @createDate 2025-01-18 23:53:59 @Entity com.example.domain.dao.StudyJavaGoodsCategoryDao
 */
public interface StudyJavaGoodsMapper extends BaseMapper<StudyJavaGoodsDao> {

  // 获取商品列表
  IPage<StudyJavaGoodsDao> getGoodsList(
      @Param("page") IPage<StudyJavaGoodsDao> page,
