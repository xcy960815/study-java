...
public interface StudyJavaSysRoleMapper {
  ...
  /** 分页查询角色列表 */
  IPage<StudyJavaSysRoleDao> getRoleList(
      @Param("page") IPage<StudyJavaSysRoleDao> page,
      @Param("studyJavaSysRoleDao") StudyJavaSysRoleDao studyJavaSysRoleDao);
  ...
  /** 获取角色信息 */
  StudyJavaSysRoleDao getRoleInfo(
      @Param("studyJavaSysRoleDao") StudyJavaSysRoleDao studyJavaSysRoleDao);
