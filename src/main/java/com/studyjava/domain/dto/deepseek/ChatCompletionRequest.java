...
public class ChatCompletionRequest {
  ...
  //        if (this == another)
  //            return true;
  //        return another instanceof ChatCompletionRequest && equalTo((ChatCompletionRequest)
  // another);
  //    }
  //
  //    private boolean equalTo(ChatCompletionRequest another) {
  //        return Objects.equals(model, another.model) && Objects.equals(messages,
  // another.messages)
  //                && Objects.equals(temperature, another.temperature) && Objects.equals(topP,
  // another.topP)
  //                && Objects.equals(n, another.n) && Objects.equals(stream, another.stream)
  //                && Objects.equals(streamOptions, another.streamOptions) && Objects.equals(stop,
  // another.stop)
  ...
  //                && Objects.equals(logitBias, another.logitBias) && Objects.equals(user,
  // another.user)
  //                && Objects.equals(responseFormat, another.responseFormat) &&
  // Objects.equals(seed, another.seed)
  //                && Objects.equals(tools, another.tools) && Objects.equals(toolChoice,
  // another.toolChoice)
  ...
  //                && Objects.equals(serviceTier, another.serviceTier) && Objects.equals(functions,
  // another.functions)
  ...
  //                + ", topP=" + topP + ", n=" + n + ", stream=" + stream + ", streamOptions=" +
  // streamOptions + ", stop="
  //                + stop + ", maxTokens=" + maxTokens + ", maxCompletionTokens=" +
  // maxCompletionTokens
  //                + ", presencePenalty=" + presencePenalty + ", frequencyPenalty=" +
  // frequencyPenalty + ", logitBias="
  //                + logitBias + ", user=" + user + ", responseFormat=" + responseFormat + ",
  // seed=" + seed + ", tools="
  //                + tools + ", toolChoice=" + toolChoice + ", parallelToolCalls=" +
  // parallelToolCalls + ", store=" + store
  //                + ", metadata=" + metadata + ", reasoningEffort=" + reasoningEffort + ",
