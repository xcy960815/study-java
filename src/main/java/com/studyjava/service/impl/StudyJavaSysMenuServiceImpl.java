...
public class StudyJavaSysMenuServiceImpl implements StudyJavaSysMenuService {
  ...
  @Resource private StudyJavaSysMenuMapper studyJavaSysMenuMapper;
   ...
   */
  @Override
  public IPage<StudyJavaSysMenuVo> getMenuList(
      IPage<StudyJavaSysMenuDao> studyJavaSysMenuDaoPage, StudyJavaSysMenuDto studyJavaSysMenuDto) {
    try {
      StudyJavaSysMenuDao studyJavaSysMenuDao = convertToDao(studyJavaSysMenuDto);
      IPage<StudyJavaSysMenuDao> menuDaoIPage =
          studyJavaSysMenuMapper.getMenuList(studyJavaSysMenuDaoPage, studyJavaSysMenuDao);
      List<StudyJavaSysMenuVo> menuVoList =
          menuDaoIPage.getRecords().stream()
              .map(this::convertToVo)
              .filter(Objects::nonNull)
              .collect(Collectors.toList());
      IPage<StudyJavaSysMenuVo> studyJavaSysMenuVoPage =
          new Page<>(
              studyJavaSysMenuDaoPage.getCurrent(),
              studyJavaSysMenuDaoPage.getSize(),
              studyJavaSysMenuDaoPage.getTotal());
  ...
  public StudyJavaSysMenuVo getMenuInfo(Serializable id) {
    ...
    try {
      ...
      StudyJavaSysMenuDao studyJavaSysMenuDao =
          studyJavaSysMenuMapper.getMenuInfo(studyJavaSysRequestMenuDao);
  ...
  public List<StudyJavaSysMenuVo> getRoutes() {
    ...
    List<StudyJavaSysMenuDao> studyJavaSysMenuDaoList =
        studyJavaSysMenuMapper.getRoutes(studyJavaSysUserVo.getId());
